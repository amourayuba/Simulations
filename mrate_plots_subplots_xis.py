...
# np.savetxt('sim_res.txt', sim_res)
# np.savetxt('pois_res.txt', pois_res)
...
if c_param == '\sigma_8':
    plt.annotate(r'$\Omega_m$ = {}'.format(omg), (0.6, 1.6), size=25)
    plt.savefig(r'integ_N_tot_{}_{:2.0f}_m{:2.1f}.pdf'.format(c_param, 100 * omg, np.log10(amlim)),
                dpi=650, bbox_inches='tight', facecolor='white',
                transparent=False)
    plt.savefig(r'integ_N_tot_{}_{:2.0f}_m{:2.1f}.png'.format(c_param, 100 * omg, np.log10(amlim)),
                dpi=650, bbox_inches='tight', facecolor='white',
                transparent=False)
else:
    plt.annotate(r'$\sigma_8$ = {}'.format(s8), (0.15, 1), size=25)
    plt.savefig(r'integ_N_tot_{}_{:2.0f}_s{:2.0f}.pdf'.format(c_param, 100 * s8,  np.log10(amlim)),
                dpi=650, bbox_inches='tight', facecolor='white', transparent=False)
    plt.savefig(r'integ_N_tot_{}_{:2.0f}_s{:2.0f}.png'.format(c_param, 100 * s8,  np.log10(amlim)),
                dpi=650, bbox_inches='tight', facecolor='white', transparent=False)
